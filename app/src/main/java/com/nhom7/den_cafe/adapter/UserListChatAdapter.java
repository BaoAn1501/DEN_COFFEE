...
public class UserListChatAdapter extends RecyclerView.Adapter<UserListChatAdapter.ViewHolder> {
    ...
    @Override
    public UserListChatAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull UserListChatAdapter.ViewHolder holder, int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, MessageActivity.class).putExtra("from", 2).putExtra("user", user));
            }
        });
    }
